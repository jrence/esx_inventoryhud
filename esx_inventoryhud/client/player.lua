...
AddEventHandler("esx_inventoryhud:openPlayerInventory", function(target, playerName)
		--PlayerData = ESX.GetPlayerData()
   		--if PlayerData.job and PlayerData.job.name == 'police' or PlayerData.job.name == 'sheriff' or PlayerData.job.name == 'ambulance' then
        targetPlayer = target
		...
		--else
			--exports['mythic_notify']:DoHudText('inform', 'You dont have permission to search')
		--end
end)
    ...
    ESX.TriggerServerCallback(
        ...
        function(data)
           ...
           -- weapons = data.weapons
            ...
            if Config.IncludeAccounts and accounts ~= nil and accounts ~= 'apple_coin' then
