...
window.addEventListener("message", function(event) {
    ...
    if (event.data.action == "display") {
        ...
        if (type === "normal") {
            ...
            $(".info-div").hide();
        } else if (type === "Pinkcage") {
            $(".info-div").hide();
        } else if (type === "Firefly") {
            $(".info-div").hide();
        } else if (type === "Crastenburg") {
            $(".info-div").hide();
        } else if (type === "Bayview") {
            $(".info-div").hide();
        } else if (type === "Perrera") {
            $(".info-div").hide();
    ...
    } else if (event.data.action == "setTrunkData") {
...
function sendNotification(item, itemlabel, count, remove) {
    ...
    $("#notifuck").fadeIn();
    if (remove) {
        $("#notifuck").append('<div class="slot" style="background-color: rgba(255, 166, 0, 0)" id="noti"><div class="item2" style = "background-image: url(\'img/items/' + item + '.png\')">' +
            '<div class="item-count">-' + count + '</div> <div class="item-name">' + itemlabel + '</div> </div ><div class="item-name-bg"></div></div>');
        //   $("#notifuck").stop(true,true).fadeIn(500).delay(1500).fadeOut(500);
        setTimeout(function() {
            $("#notifuck").fadeOut();
        }, 1500);
    } else {
...
$(document).ready(function() {
    ...
    $('#playerInventory').droppable({
        drop: function(event, ui) {
            ...
            } else if (type === "Pinkcage" && itemInventory === "second") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/TakeFromPinkcage", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "Firefly" && itemInventory === "second") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/TakeFromFirefly", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "Crastenburg" && itemInventory === "second") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/TakeFromCrastenburg", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "Bayview" && itemInventory === "second") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/TakeFromBayview", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "Perrera" && itemInventory === "second") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/TakeFromPerrera", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "PoliceWeaps" && itemInventory === "second") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/TakeFromPoliceWeaps", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
    ...
    $('#otherInventory').droppable({
        drop: function(event, ui) {
            ...
            } else if (type === "Pinkcage" && itemInventory === "main") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/PutIntoPinkcage", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "Firefly" && itemInventory === "main") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/PutIntoFirefly", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "Crastenburg" && itemInventory === "main") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/PutIntoCrastenburg", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "Bayview" && itemInventory === "main") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/PutIntoBayview", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            } else if (type === "Perrera" && itemInventory === "main") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/PutIntoPerrera", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
            ...
            } else if (type === "PoliceWeaps" && itemInventory === "main") {
                disableInventory(500);
                $.post("http://esx_inventoryhud/PutIntoPoliceWeaps", JSON.stringify({
                    item: itemData,
                    number: parseInt($("#count").val())
                }));
